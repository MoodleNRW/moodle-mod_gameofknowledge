...
`, "",{"version":3,"sources":["webpack://./app/components/board/board.vue"],"names":[],"mappings":"AACA;EACI,aAAa;EACb,mBAAmB;EACnB,cAAc;EACd,mBAAmB;AAAA;AAJvB;IAOQ,aAAa;IACb,mBAAmB;IACnB,cAAc;IACd,WAAW;AAAA;AAVnB;MAaY,aAAa;MACb,sBAAsB;MACtB,cAAc;MACd,WAAW;AAAA","sourcesContent":["\n.board {\n    display: flex;\n    flex-direction: row;\n    flex: 0 1 auto;\n    aspect-ratio: 1 / 1;\n\n    .board-x {\n        display: flex;\n        flex-direction: row;\n        flex: 1 1 auto;\n        gap: 0.25em;\n\n        .board-y {\n            display: flex;\n            flex-direction: column;\n            flex: 1 1 auto;\n            gap: 0.25em;\n        }\n    }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
